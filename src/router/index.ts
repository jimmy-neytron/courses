...
{path:'/app/lessons/:lessonId/editor',component:()=>import('@/pages/lessons/[lessonId]/editor.vue'),meta:{title:'Редактор урока',auth:true}},
{path:'/preview/courses/:courseId',component:()=>import('@/pages/preview/courses/[courseId].vue'),meta:{auth:true}},
{path:'/preview/lessons/:lessonId',component:()=>import('@/pages/preview/lessons/[lessonId].vue'),meta:{auth:true}},
